...
corresponds to [[https://labelthis.lib.ucdavis.edu/view/0162][Label 0162]].
...
** Inglenook Burgandy and Pinot Noir

Here's some examples from wines that come from the same winery.  We can see
...
most famous wines from the United States.
